...
--###### Security-Settings ##########################################
set serveroutput on;
grant scheduler_admin to ora41;     --(executet by SYS in SQL_PLUS) 
grant create any trigger to ora41;  --(executet by SYS in SQL_PLUS)
grant create procedure to ora41;    --(executet by SYS in SQL_PLUS)
/
--######______________________________________________________######
